...
"""Standard stdio MCP transport for the same Jarvis computer broker."""
...
def handle(message):
 ...
 try:
  if method=='initialize':result={'protocolVersion':params.get('protocolVersion','2024-11-05'),'capabilities':{'tools':{}},'serverInfo':{'name':'side-chat-jarvis','version':'1.4.0'}}
