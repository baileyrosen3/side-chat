...
Canvas {
    ...
    onPaint: {
        ...
        case "settings": line(5,6,19,6); line(5,12,19,12); line(5,18,19,18); c.stroke(); c.beginPath(); c.fillStyle = String(Color.popups.background); c.rect(8,4,3,4); c.rect(14,10,3,4); c.rect(8,16,3,4); c.fill(); break
        case "expand": line(9,5,19,5); line(19,5,19,15); line(19,5,5,19); break
        case "collapse": line(5,9,5,19); line(5,19,15,19); line(5,19,19,5); break
