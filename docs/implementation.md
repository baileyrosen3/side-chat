...
| Local speech | Parakeet Unified recognition reusing the downloaded Voxtype model, streaming Pocket TTS, optional Kokoro output and legacy recognition, live captions, microphone/playback indicators, push-to-talk, hands-free listening, and optional “Hey Jarvis” wake/follow-up listening. |
